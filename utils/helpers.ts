...
export const getStoryImageTransform = (storyId: number, code?: string) => {
  ...
  return process.dev ? `${SITE.cdn}/uploads/${bondCode}-${storyId}` : `https://res.cloudinary.com/dyxajqsia/image/fetch/c_thumb,w_75,h_75/${SITE.cdn}/uploads/${bondCode}-${storyId}`;
};
