      ...
      <div class="col-lg-8 col-xl-10 mx-auto">
        <div class="bg-body rounded-3 px-3 py-4 p-lg-4 mb-2">
          ...
          <section id="agreement">
            ...
            <p>We operate the website <a href="https://mappedlove.com">mappedlove.com</a> (the "<strong>Site</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").</p>
          ...
          <section id="intelectual-property-rights">
            <h4>2. INTELLECTUAL PROPERTY RIGHTS</h4>
            <h5>Our intellectual property</h5>
            <p>All content within our Services, including source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics (collectively referred to as the "Content"), is owned by us.</p>
            <p>The Content are provided in or through the Services "AS IS" for your personal, non-commercial use only.</p>
            ...
            <p>You understand that Contributions may be viewable by other users of the Services and possibly through third-party websites if you choose to make them public.</p>
            ...
            <ul>
              <li>confirm that you have read and agree with our "<a href="#prohibited-activities">PROHIBITED ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
          ...
          <section id="purchases-and-payment">
            ...
            <ul>
              ...
              <li>PayPal</li>
              <li>Google Pay (Chrome only)</li>
              <li>Apple Pay (HTTPS pages on Safari only)</li>
            </ul>
          ...
          <section id="user-generated-contributions">
            ...
            <ul>
              ...
              <li>Any use of the Services in violation of the foregoing violates these Legal Terms and may result in, among other things, termination or suspension of your rights to use the Services.</li>
            </ul>
          </section>
          ...
          <section id="california-users-and-residents">
            <h4>24. CALIFORNIA USERS AND RESIDENTS</h4>
